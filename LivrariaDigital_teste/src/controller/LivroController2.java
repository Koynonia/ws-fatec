...
public class LivroController2 implements ActionListener{
	...
	public LivroController2(JTextField txtIsbn, JTextField txtTitulo,
	...
	public void gravarLivro(){
		...
		ArquivoLivro2 daoLivro = new ArquivoLivro2();
		if( validaCampos() ){
			try {
				...
				livro.setPrecoVenda( Float.parseFloat( txtPrecoVenda.getText() ) ); // CORRIGIR
//				livro.setIndice(  );
